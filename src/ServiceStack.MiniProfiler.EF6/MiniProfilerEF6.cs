namespace ServiceStack.MiniProfiler.EF6
{
    using System;
    ...
    public static class MiniProfilerEF6
    {
        ...
        {
            Profiler.Settings.ExcludeAssembly("EntityFramework");
            Profiler.Settings.ExcludeAssembly("EntityFramework.SqlServer");
            Profiler.Settings.ExcludeAssembly("EntityFramework.SqlServerCompact");
            Profiler.Settings.ExcludeAssembly(typeof(MiniProfilerEF6).Assembly.GetName().Name);
        }
    }
}
